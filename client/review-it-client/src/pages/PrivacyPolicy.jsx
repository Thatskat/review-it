...
const PrivacyPolicy = () => {
  return (
    <div className={styles.privacyPolicy}>
      <Helmet>
        <title>privacy policy | review it</title>
      </Helmet>
      <h1>Our Privacy Policy</h1>
      <p>
        Review It is committed to providing quality services to you and this
      ...
      <p>
        ...
        <a href="https://www.oaic.gov.au/" target="_blank" rel="noreferrer" title="Office of the Australian Information Commissioner">
      ...
      <p>
        This Personal Information is obtained in many ways including by email
        and from third parties. We don&apos;t guarantee website links or policy
      ...
      <p>
        Review It will not charge any fee for your access request, but may
      ...
      <div>
        ...
        <ul>
          <li><AiFillMail />enquiries@reviewit.com.au</li>
          <li><AiFillPhone />(03) 9372 1826</li>
        </ul>
      </div>
    </div>
  );
